...
try:
    for (name,pos) in zip(names,positions):
        ...
        namefont = ImageFont.truetype("Fonts/prodsans.ttf", 80)
        posfont = ImageFont.truetype("Fonts/prodsans.ttf", 100)
        ...
        # ezgmail.send(email, 'Statesmanship MUN Merit Certificate', 'Find your merit certificate attached below. If there is any discrepancy, please contact us at this email.',['./Certificates/'+name+'.png'])
